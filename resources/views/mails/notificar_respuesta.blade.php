...
@section('titulo')
    ¡{{$data['name']}} hay una nueva respuesta en tu pregunta que realizaste!
@endsection
...
@section('asunto')
    <strong>Pregunta:</strong> <br>{{$pregunta['pregunta']}}
@endsection

@section('cuerpo1')
    ¡Vamos a ver la nueva respuesta que hay en tu pregunta!
@endsection

@section('cuerpo2')
    <center>
        <a href="{{ url('https://schoolnotes.live/preguntas/'.$pregunta->id.'#'.$respuesta->id) }}" class="es-button" target="_blank" style="background: #ffffff none repeat scroll 0% 0%; border-color: #ffffff; color: #00cba0; border-width: 15px 25px;">
