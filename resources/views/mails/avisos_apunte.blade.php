...
@section('titulo')
    ¡{{$data['name']}} ha creado un nuevo Apunte!
@endsection
...
@section('cuerpo1')
    ¿Quieres ir a ver el nuevo apunte?, es muy sencillo da clic aca abajo para poder descargar su nuevo apunte.
@endsection

@section('cuerpo2')
    <center>
        <a href="{{ url('https://schoolnotes.live/documentos/'.$apunte->slug) }}" class="es-button" target="_blank" style="background: #ffffff none repeat scroll 0% 0%; border-color: #ffffff; color: #00cba0; border-width: 15px 25px;">
