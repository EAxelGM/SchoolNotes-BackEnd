    ...
    <style>
        ...
        */
        ...
        .es-button-border {
            ...
            border-color: #00cba0 #00cba0 #00cba0 #00cba0;
            background: #00cba0;
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="es-infoblock esd-block-text es-m-txt-c" align="left">
                                                                                        <p style="font-family: arial, helvetica\ neue, helvetica, sans-serif;">@yield('pestana1')<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                ...
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="88999" align="center">
                                        <table class="es-header-body" style="background-color: #ffffff;" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p30t es-p30b es-p40r es-p40l" style="background-color: #707070;" bgcolor="#707070" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p10t es-p20b" align="center">
                                                                                        <span class="es-button-border" style="border-width: 0px; border-style: solid; background: none 0% 0% repeat scroll #00cba0; border-color: #00cba0;">
                                                                                            @yield('boton')
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t" align="left">
                                                                                        <p style="color: #222222; font-size: 14px;"><strong>@yield('nombreEmpresa')</strong><br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text" align="left">
                                                                                        <p style="color: #666666; font-size: 14px;">@yield('descripcionEmpresa')</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
